...
function aluminumCuttingReport(M4,B10,C10,) {
    ...
    if (M4 === "Sliding D12") {
        ...
        T4 = H4 - 1 + 0.7 + 8.9;
        U4 = I4 - 1 + 1.4 - 0.1;
    } else if (M4 === "Sliding D10" || M4 === "Sliding D10p" || M4 === "Sliding S") {
        Q4 = E4;
        R4 = F4;
        S4 = G4;
        T4 = H4;
...
async function updatetotalMotherEquation(resultsArrayAfter, id) {
    ...
    resultsArrayAfter.forEach(async function (result) {
      ...
      var k = {
        ...
        E10F: sanitizeValue(result.E10F),
        F10F: sanitizeValue(result.F10F),
        G10F: sanitizeValue(result.G10F),
        H10F: sanitizeValue(result.H10F),
        I10F: sanitizeValue(result.I10F),
        J10F: sanitizeValue(result.J10F),
        M10F: sanitizeValue(result.M10F),
        N10F: sanitizeValue(result.N10F),
        Q10F: sanitizeValue(result.Q10F),
        K10F: sanitizeValue(result.K10F),
        L10F: sanitizeValue(result.L10F),
        O10F: sanitizeValue(result.O10F),
        P10F: sanitizeValue(result.P10F)
      };
...
module.exports = {calculateResults,functionPrice,updateTotal,refreshDiscount,motherEquation,totalMotherEquation,calculateValues,aluminumCuttingReport,updatetotalMotherEquation}
